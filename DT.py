...
max_depth = range(17, 20, 2)
min_samples_leaf = range(13, 15, 2)
gridparamtree = [{'max_depth': max_depth, 'min_samples_leaf': min_samples_leaf}]

clf = GridSearchCV(estimator=DecisionTreeClassifier(criterion='gini'), param_grid=gridparamtree, cv=5,
...
plt.colorbar()
plt.xticks(np.arange(len(min_samples_leaf)), min_samples_leaf, rotation=45)
