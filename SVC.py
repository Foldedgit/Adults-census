...
gamma = ['auto']
print(C, gamma)
gridparamSVC = [{'C': C, 'gamma': gamma}]

clf = GridSearchCV(estimator=SVC(kernel='rbf'), param_grid=gridparamSVC, cv=5,
...
with open('besSVC.txt', 'w') as file:
...
model_filename = 'SVCmodel.joblib'
